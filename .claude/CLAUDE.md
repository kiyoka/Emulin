...
- **実機 GNU coreutils 11 種類が動作** — ls / cat / wc / echo / true /
  false / dirname / basename / uname / grep / sed (動的リンク + libc +
  libselinux + libpcre2 + libacl) (Phase 27 step 1-3)
...
- **回帰テスト 157 本 PASS / 0 FAIL / 0 SKIP** — sandbox を Linux 側 /tmp に
...
- 回帰 **157 PASS / 0 FAIL / 0 SKIP** (Phase 26 の 140 + real-coreutils 17 本)
- 実機バイナリ 11 種類 (動的リンク GNU coreutils) が動作
