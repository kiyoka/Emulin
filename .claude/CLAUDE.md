...
- **回帰テスト 191 本 PASS / 0 FAIL / 0 SKIP** — sandbox を Linux 側 /tmp に
...
- 回帰 **191 PASS / 0 FAIL / 0 SKIP** (Phase 26 の 140 + binary 1 +
  real-coreutils 45 + real-heavy 5)
- 実機バイナリ 32+ 種類が動作: GNU coreutils 24 + bash (10 機能) +
