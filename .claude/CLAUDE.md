...
- **git clone HTTPS は CA load 後の TLS handshake で別 SIMD 問題** (step 44
  完了時点): CA load が直ったので handshake まで進むが、libgnutls 内の
  別 RIP=0x40282d75 で segfault。同種の RIP-relative bug が他 SSE 命令にも
  残っている可能性
