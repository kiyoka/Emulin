...
- **回帰テスト 201 本 PASS / 0 FAIL / 0 SKIP**、xargs -P / wait -n で
...
3. シグナル更なる拡張: SIGALRM 自動配信 (alarm/setitimer)、sigprocmask、
   sa_mask 中ハンドラの再入抑止
4. dist の充実: jlink で JRE 同梱の self-contained zip、Win/Linux/macOS
   別の zip 出力
