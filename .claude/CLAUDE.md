...
- **回帰テスト 180 本 PASS / 0 FAIL / 0 SKIP** — sandbox を Linux 側 /tmp に
...
- 回帰 **180 PASS / 0 FAIL / 0 SKIP** (Phase 26 の 140 + real-coreutils 35
  + real-heavy 5)
- 実機バイナリ 26+ 種類が動作: GNU coreutils 24 + bash + python3 + openssl
