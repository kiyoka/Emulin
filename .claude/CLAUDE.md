...
- **回帰テスト 175 本 PASS / 0 FAIL / 0 SKIP** — sandbox を Linux 側 /tmp に
...
- 回帰 **175 PASS / 0 FAIL / 0 SKIP** (Phase 26 の 140 + real-coreutils 35 本)
- 実機バイナリ 24+ 種類 (動的リンク GNU coreutils) と bash 非対話が動作
