...
declare -A EXT_LABELS=(
    ...
    [elf-probe]="$ROOT/scripts/elf-probe-smoke.sh|ELF guest architecture probe smoke (issue #951)"
)
...
EXT_JOBS=${EXT_JOBS:-4}
EXT_PIDS=()
for label in elf-probe ash-noni ash-cook jline-smoke ash-jline ash-applet cyg-symlink cyg-dentry cyg-casemap cyg-caseenc cyg-mode jit-correct segv-child pool-exhaust pool-shrink env-inherit whp-gpabacking launcher-subs; do
