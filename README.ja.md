...
> 0.8.4 時点で、ビルド済みの配布 zip は **Windows 用のみ**公開しています
...
5. **1 コマンド実行モード / 実機 binary の実行**
   `debian-emulin-0.8.4-windows` には git / curl / openssl / python3 等が同梱
...
`debian-emulin-0.8.4-windows-x64.zip` は **Debian 13 (trixie) base 相当**の
