...
final class Aarch64DecodedInsn {
  enum Operation {
    ...
    SBFM, BFM, UBFM, EXTR,
    MADD, MSUB, UMADDL, UMSUBL, UDIV, SDIV,
    ...
    DUP_VECTOR_BYTE, LD1_VECTOR_16B, CMEQ_VECTOR_BYTE, CMEQ_VECTOR_BYTE_ZERO,
    BIT_VECTOR, BIC_VECTOR_IMMEDIATE_HALFWORD, UMAXP_VECTOR_BYTE,
    ADDP_VECTOR_BYTE, EXT_VECTOR_16B, CMHS_VECTOR_BYTE,
    SHRN_VECTOR_8B, FMOV_GENERAL_FROM_D, MOVE_GENERAL_FROM_VECTOR_LANE,
